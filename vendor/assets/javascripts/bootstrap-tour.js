      ...
      return this.each(function() {
        ...
        $tips.each(function(idx) {
          ...
          $target.popover({
            ...
            content: "<p>" + ($li.html()) + "</p><p style='display:none'><a href=\"#\" class=\"tour-tip-next btn btn-success\" data-touridx=\"" + (idx + 1) + "\">" + ((idx + 1) < $tips.length ? 'Next <i class="icon-chevron-right icon-white"></i>' : '<i class="icon-ok icon-white"></i> Done') + "</a></p>",
